...
export interface AlertItem { id: string; tank_id: string; tank_name: string; alert_type: string; severity: "critical" | "warning" | "info"; status: "ACTIVE" | "ACKNOWLEDGED" | "RESOLVED"; message: string; created_at: string; }
