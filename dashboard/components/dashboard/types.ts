...
export interface SensorReading { id: string; thingspeak_channel_id: number; thingspeak_entry_id: number; level: number | null; gas_level: number | null; temperature: number | null; battery: number | null; latitude: number | null; longitude: number | null; recorded_at: string; created_at: string; }
