...
export interface SensorReading { id: string; tank_id: string; thingspeak_channel_id: number | null; thingspeak_entry_id: number | null; device_reading_id?: string | null; level: number | null; gas_level: number | null; temperature: number | null; battery: number | null; recorded_at: string; created_at: string; }
...
export interface AnalyticsSummary { highestFill: number | null; averageFill: number | null; highestGas: number | null; averageTemperature: number | null; latestBatteryVoltage: number | null; reportingDeviceCount: number; offlineDeviceCount: number; }
